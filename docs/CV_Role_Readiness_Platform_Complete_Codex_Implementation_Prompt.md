...
- Anti-spam proof: honeypot, server-side rate limiting, and a required one-use server-issued word-math answer.
...
- server-issued public word-math verification with a short-lived HttpOnly cookie
