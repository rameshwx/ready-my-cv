...
mixin _$ScanState {
 ...
 ScanStage get stage; JobRole? get role; String? get seniority; AnalysisResult? get result; String? get jobHandle; String? get errorMessage; String? get errorCode; bool get consentGiven; bool get emailSent; bool get busy;
...
@override
int get hashCode => Object.hash(runtimeType,stage,role,seniority,result,jobHandle,errorMessage,errorCode,consentGiven,emailSent,busy);

@override
String toString() {
  return 'ScanState(stage: $stage, role: $role, seniority: $seniority, result: $result, jobHandle: $jobHandle, errorMessage: $errorMessage, errorCode: $errorCode, consentGiven: $consentGiven, emailSent: $emailSent, busy: $busy)';
}
...
@useResult
$Res call({
 ScanStage stage, JobRole? role, String? seniority, AnalysisResult? result, String? jobHandle, String? errorMessage, String? errorCode, bool consentGiven, bool emailSent, bool busy
});
...
/// Create a copy of ScanState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? stage = null,Object? role = freezed,Object? seniority = freezed,Object? result = freezed,Object? jobHandle = freezed,Object? errorMessage = freezed,Object? errorCode = freezed,Object? consentGiven = null,Object? emailSent = null,Object? busy = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( ScanStage stage,  JobRole? role,  String? seniority,  AnalysisResult? result,  String? jobHandle,  String? errorMessage,  String? errorCode,  bool consentGiven,  bool emailSent,  bool busy)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ScanState() when $default != null:
return $default(_that.stage,_that.role,_that.seniority,_that.result,_that.jobHandle,_that.errorMessage,_that.errorCode,_that.consentGiven,_that.emailSent,_that.busy);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( ScanStage stage,  JobRole? role,  String? seniority,  AnalysisResult? result,  String? jobHandle,  String? errorMessage,  String? errorCode,  bool consentGiven,  bool emailSent,  bool busy)  $default,) {final _that = this;
switch (_that) {
case _ScanState():
return $default(_that.stage,_that.role,_that.seniority,_that.result,_that.jobHandle,_that.errorMessage,_that.errorCode,_that.consentGiven,_that.emailSent,_that.busy);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( ScanStage stage,  JobRole? role,  String? seniority,  AnalysisResult? result,  String? jobHandle,  String? errorMessage,  String? errorCode,  bool consentGiven,  bool emailSent,  bool busy)?  $default,) {final _that = this;
switch (_that) {
case _ScanState() when $default != null:
return $default(_that.stage,_that.role,_that.seniority,_that.result,_that.jobHandle,_that.errorMessage,_that.errorCode,_that.consentGiven,_that.emailSent,_that.busy);case _:
  return null;
...
class _ScanState implements ScanState {
  const _ScanState({this.stage = ScanStage.idle, this.role, this.seniority, this.result, this.jobHandle, this.errorMessage, this.errorCode, this.consentGiven = false, this.emailSent = false, this.busy = false});
...
/// Create a copy of ScanState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? stage = null,Object? role = freezed,Object? seniority = freezed,Object? result = freezed,Object? jobHandle = freezed,Object? errorMessage = freezed,Object? errorCode = freezed,Object? consentGiven = null,Object? emailSent = null,Object? busy = null,}) {
